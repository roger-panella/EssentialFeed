...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = makeItem(id: UUID(), imageURL: URL(string: "http://www.google.com")!)

        let item2 = makeItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "http://anotherurl.com")!)
